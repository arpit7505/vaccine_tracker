...
# state_district_details = tracker.get_state_district_details()
state_district_details = {'Andaman and Nicobar Islands': ['Nicobar', 'North and Middle Andaman', 'South Andaman'],
                          ...
                          'Bihar': ['Araria', 'Arwal', 'Aurangabad', 'Banka', 'Begusarai', 'Bhagalpur', 'Bhojpur',
                                    ...
                                    'Siwan', 'Supaul', 'Vaishali', 'West Champaran'], 'Chandigarh': ['Chandigarh'],
                          'Chhattisgarh': ['Balod', 'Baloda bazar', 'Balrampur', 'Bastar', 'Bemetara', 'Bijapur',
                                           'Bilaspur', 'Dantewada', 'Dhamtari', 'Durg', 'Gariaband',
                                           'Gaurela Pendra Marwahi ', 'Janjgir-Champa', 'Jashpur', 'Kanker', 'Kawardha',
                                           'Kondagaon', 'Korba', 'Koriya', 'Mahasamund', 'Mungeli', 'Narayanpur',
                                           'Raigarh', 'Raipur', 'Rajnandgaon', 'Sukma', 'Surajpur', 'Surguja'],
                          'Dadra and Nagar Haveli': ['Dadra and Nagar Haveli'], 'Daman and Diu': ['Daman', 'Diu'],
                          'Delhi': ['Central Delhi', 'East Delhi', 'New Delhi', 'North Delhi', 'North East Delhi',
                                    'North West Delhi', 'Shahdara', 'South Delhi', 'South East Delhi',
                                    'South West Delhi', 'West Delhi'], 'Goa': ['North Goa', 'South Goa'],
                          'Gujarat': ['Ahmedabad', 'Ahmedabad Corporation', 'Amreli', 'Anand', 'Aravalli',
                                      'Banaskantha', 'Bharuch', 'Bhavnagar', 'Bhavnagar Corporation', 'Botad',
                                      'Chhotaudepur', 'Dahod', 'Dang', 'Devbhumi Dwaraka', 'Gandhinagar',
                                      'Gandhinagar Corporation', 'Gir Somnath', 'Jamnagar', 'Jamnagar Corporation',
                                      'Junagadh', 'Junagadh Corporation', 'Kheda', 'Kutch', 'Mahisagar', 'Mehsana',
                                      'Morbi', 'Narmada', 'Navsari', 'Panchmahal', 'Patan', 'Porbandar', 'Rajkot',
                                      'Rajkot Corporation', 'Sabarkantha', 'Surat', 'Surat Corporation',
                                      'Surendranagar', 'Tapi', 'Vadodara', 'Vadodara Corporation', 'Valsad'],
                          'Haryana': ['Ambala', 'Bhiwani', 'Charkhi Dadri', 'Faridabad', 'Fatehabad', 'Gurgaon',
                          ...
                          'Jammu and Kashmir': ['Anantnag', 'Bandipore', 'Baramulla', 'Budgam', 'Doda', 'Ganderbal',
                          ...
                          'Karnataka': ['Bagalkot', 'Bangalore Rural', 'Bangalore Urban', 'BBMP', 'Belgaum', 'Bellary',
                                        'Bidar', 'Chamarajanagar', 'Chikamagalur', 'Chikkaballapur', 'Chitradurga',
                                        'Dakshina Kannada', 'Davanagere', 'Dharwad', 'Gadag', 'Gulbarga', 'Hassan',
                                        'Haveri', 'Kodagu', 'Kolar', 'Koppal', 'Mandya', 'Mysore', 'Raichur',
                                        'Ramanagara', 'Shimoga', 'Tumkur', 'Udupi', 'Uttar Kannada', 'Vijayapura',
                                        'Yadgir'],
                          'Kerala': ['Alappuzha', 'Ernakulam', 'Idukki', 'Kannur', 'Kasaragod', 'Kollam', 'Kottayam',
                                     'Kozhikode', 'Malappuram', 'Palakkad', 'Pathanamthitta', 'Thiruvananthapuram',
                                     'Thrissur', 'Wayanad'], 'Ladakh': ['Kargil', 'Leh'],
                          'Lakshadweep': ['Agatti Island', 'Lakshadweep'],
                          'Madhya Pradesh': ['Agar', 'Alirajpur', 'Anuppur', 'Ashoknagar', 'Balaghat', 'Barwani',
                          ...
                          'Meghalaya': ['East Garo Hills', 'East Jaintia Hills', 'East Khasi Hills', 'North Garo Hills',
                                        ...
                                        'West Khasi Hills'],
                          'Mizoram': ['Aizawl East', 'Aizawl West', 'Champhai', 'Kolasib', 'Lawngtlai', 'Lunglei',
                                      'Mamit', 'Serchhip', 'Siaha'],
                          ...
                          'Punjab': ['Amritsar', 'Barnala', 'Bathinda', 'Faridkot', 'Fatehgarh Sahib', 'Fazilka',
                                     'Ferozpur', 'Gurdaspur', 'Hoshiarpur', 'Jalandhar', 'Kapurthala', 'Ludhiana',
                                     'Mansa', 'Moga', 'Pathankot', 'Patiala', 'Rup Nagar', 'Sangrur', 'SAS Nagar',
                                     'SBS Nagar', 'Sri Muktsar Sahib', 'Tarn Taran'],
                          'Rajasthan': ['Ajmer', 'Alwar', 'Banswara', 'Baran', 'Barmer', 'Bharatpur', 'Bhilwara',
                                        'Bikaner', 'Bundi', 'Chittorgarh', 'Churu', 'Dausa', 'Dholpur', 'Dungarpur',
                                        'Hanumangarh', 'Jaipur I', 'Jaipur II', 'Jaisalmer', 'Jalore', 'Jhalawar',
                                        'Jhunjhunu', 'Jodhpur', 'Karauli', 'Kota', 'Nagaur', 'Pali', 'Pratapgarh',
                                        'Rajsamand', 'Sawai Madhopur', 'Sikar', 'Sirohi', 'Sri Ganganagar', 'Tonk',
                                        'Udaipur'],
                          'Sikkim': ['East Sikkim', 'North Sikkim', 'South Sikkim', 'West Sikkim'],
                          'Tamil Nadu': ['Aranthangi', 'Ariyalur', 'Attur', 'Chengalpet', 'Chennai', 'Cheyyar',
                                         'Coimbatore', 'Cuddalore', 'Dharmapuri', 'Dindigul', 'Erode', 'Kallakurichi',
                                         'Kanchipuram', 'Kanyakumari', 'Karur', 'Kovilpatti', 'Krishnagiri', 'Madurai',
                                         'Nagapattinam', 'Namakkal', 'Nilgiris', 'Palani', 'Paramakudi', 'Perambalur',
                                         'Poonamallee', 'Pudukkottai', 'Ramanathapuram', 'Ranipet', 'Salem',
                                         'Sivaganga', 'Sivakasi', 'Tenkasi', 'Thanjavur', 'Theni',
                                         'Thoothukudi (Tuticorin)', 'Tiruchirappalli', 'Tirunelveli', 'Tirupattur',
                          ...
                          'Uttar Pradesh': ['Agra', 'Aligarh', 'Ambedkar Nagar', 'Amethi', 'Amroha', 'Auraiya',
                                            'Ayodhya', 'Azamgarh', 'Badaun', 'Baghpat', 'Bahraich', 'Balarampur',
                                            'Ballia', 'Banda', 'Barabanki', 'Bareilly', 'Basti', 'Bhadohi', 'Bijnour',
                          ...
                          'West Bengal': ['Alipurduar District', 'Bankura', 'Basirhat HD (North 24 Parganas)',
                                          'Birbhum', 'Bishnupur HD (Bankura)', 'Cooch Behar', 'COOCHBEHAR',
                                          'Dakshin Dinajpur', 'Darjeeling', 'Diamond Harbor HD (S 24 Parganas)',
                                          'East Bardhaman', 'Hoogly', 'Howrah', 'Jalpaiguri', 'Jhargram', 'Kalimpong',
                                          'Kolkata', 'Malda', 'Murshidabad', 'Nadia', 'Nandigram HD (East Medinipore)',
                                          'North 24 Parganas', 'Paschim Medinipore', 'Purba Medinipore', 'Purulia',
                                          'Rampurhat HD (Birbhum)', 'South 24 Parganas', 'Uttar Dinajpur',
                                          'West Bardhaman']}
